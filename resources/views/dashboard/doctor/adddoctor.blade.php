					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form method="post" action="{{route('dashboard.doctor.store')}}" enctype="multipart/form-data"
                              ...
                              @enderror		
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="content" name="Position"  class="form-control" value="{{ old('Position') }}">{{ old('Position') }}</textarea>
												@error('Position')
                                                {{ $message }}
                                                  @enderror
											</div>
